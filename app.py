...
with st.sidebar:
    st.markdown(
        ...
        f'<span class="rainbow-text" style="font-size: 95%;">TTM-Squeeze-EMA</span><br><span style="font-size:calc(0.75rem * 1.33 * 1.22);">{APP_VERSION}</span><br><span style="font-size:13px; color:#888; font-family:\'JetBrains Mono\', monospace;">SINCE 2026.05.24 23:51</span></div>',
        unsafe_allow_html=True,
    )
