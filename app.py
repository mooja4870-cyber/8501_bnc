"""
AI QUANTUM — OKX Auto-Trading Dashboard (v1.1.94)
...
with st.sidebar:
    st.markdown(
        '<div class="quantum-logo"><span class="quantum-logo-title">MACD-BB-EMA</span><br><span class="quantum-version">v1.1.94</span></div>',
        unsafe_allow_html=True,
    )
    st.markdown("---")
    st.markdown(
