"""
AI QUANT — OKX Auto-Trading Dashboard (v2.1.2)
...
with st.sidebar:
    st.markdown(
        '<div class="quantum-logo"><span class="quantum-logo-title">MACD-BB-EMA</span><br><span class="quantum-version">v2.1.2</span></div>',
        unsafe_allow_html=True,
    )
    st.markdown("---")
    st.markdown(
