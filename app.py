"""
AI QUANTUM — OKX Auto-Trading Dashboard (v1.1.87)
...
with st.sidebar:
    st.markdown(
        '<div class="quantum-logo"><span class="quantum-logo-title">MACD-BB-EMA</span><br><span class="quantum-version">v1.1.87</span></div>',
        unsafe_allow_html=True,
    )
    st.markdown("---")
    st.markdown(
    ...
    st.markdown(
        """
        <div style="font-family:'IBM Plex Mono';font-size:0.72rem;color:#666;line-height:1.6;">
