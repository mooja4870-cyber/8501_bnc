"""
AI QUANT — OKX Auto-Trading Dashboard (v2.1.0)
...
with st.sidebar:
    st.markdown(
        '<div class="quantum-logo"><span class="quantum-logo-title">MACD-BB-EMA</span><br><span class="quantum-version">v2.1.0</span></div>',
        unsafe_allow_html=True,
    )
    st.markdown("---")
    st.markdown(
    ...
    st.markdown(
        ...
        <code style="font-size:0.8rem; color:#aaa;">netstat -ano | findstr :8502</code><br><br>
        <b style="color:#ef4444;">RollBack (비상 복구)</b><br>
        <code style="font-size:0.8rem; color:#aaa;">git checkout v1.2.10</code>
        </div>
        """,
        unsafe_allow_html=True,
    )
